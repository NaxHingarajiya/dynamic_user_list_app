        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-links navbar-nav">
              ...
              <li className="nav-item">
                <a href="" className="nav-link fs-4">Categories</a>
              </li>
             <li className="nav-item">
                <a href="" className="nav-link fs-4" >Attentions</a>
              </li>
              <li className="nav-item text-white fs-4">
                Total users : <span className="bi bi-person"></span>
        ...
        <div className="row">
          {Data && Data.map((item) => (
            <div className="col-12 col-md-6 col-lg-12 mb-4" key={item.id}>
              <Card className="bg-danger  text-black h-100">
